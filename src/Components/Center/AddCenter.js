                    ...
                    <div className='signup'>
                        <form onSubmit={handleSubmit} className='form'>
                            ...
                            <div className="form-floating ">
                                <input type="text" class="form-control" id="center_Name" name="center_Name" value={formValues.center_Name} onChange={handleChange} />
                                <label htmlFor="center_Name">Center Name</label>
                            </div><p>{formErrors.center_Name}</p>
                            <div className="form-floating ">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="phone" name="phone_number" value={formValues.phone_number} onChange={handleChange} />
                                <label htmlFor="PhoneNumber">PhoneNumber</label>
                            </div><p>{formErrors.phone_number}</p>
                            <div class="form-floating">
                                <input type="text" class="form-control" id="location" name="centerLocation" value={formValues.centerLocation} onChange={handleChange} />
                                <label htmlFor="Location">Center Location</label>
                            </div><p>{formErrors.centerLocation}</p>
                            ...
                            <div className="form-floating ">
                                <input type="email" class="form-control" id="email" name="personal_Email" value={formValues.personal_Email} onChange={handleChange} />
                                <label htmlFor="email">Personal Email</label>
                            </div><p>{formErrors.personal_Email}</p>
